...
class RulesGlobalController extends BaseApiController
{
    ...
    public function index(Request $request)
    {
        ...
        //请求数据对象object
        $Rules = RulesGlobal::when($id, function ($query) use ($id) {
    ...
    //查询详情
    public function show(Request $request, RulesGlobal $Rules)
    {
        $Rules = $Rules->toArray();
        // $type                    = RuleType::GetTypeName();
        // $Rules['type_rule']   = $type[$Rules['type_rule']];
        // $Rules['param_site']  = RulesGlobal::$param_site[$Rules['param_site']];
        // $Rules['rule_status'] = RulesGlobal::$rule_status[$Rules['rule_status']];
    ...
    {
        $rules = [
            'request_uri'   => 'required_if:param_site,0|starts_with:/|bail',
    ...
    //更新
    public function update(Request $request, RulesGlobal $Rules)
    {
        $rules = [
    ...
    public function changeStatus(Request $request)
    {
        ...
        $this->validator($rules, $this->customAttributes);
        $Rules = RulesGlobal::whereIn('id', $request->input('id'))->get();
