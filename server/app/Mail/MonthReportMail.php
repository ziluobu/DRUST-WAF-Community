...
class MonthReportMail extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        return $this->view('month-report')
            ->subject("【鼎信云防护服务平台】 河南省鼎信信息安全等级测评有限公司 防护月报")
            ->attach(\Storage::disk('report')->path('20220317/ee865e32-7876-409c-ac59-a2ba252b092a.docx'), ['as' => '河南省鼎信信息安全等级测评有限公司_2月防护报告 (2022-02-01_2022-02-28).docx']);
    }
