...
')
     ...
     */ 
        ...
        {
                        return \Basemkhirat\Elasticsearch\Connection::create($config);
        }
                    /**
        ...
        {
                        /** @var \Basemkhirat\Elasticsearch\Connection $instance */
                        return $instance->connection($name);
        }
                    /**
         * 
         *
         * @param \Elasticsearch\ClientBuilder $clientBuilder
         * @param array $config
         * @return \Elasticsearch\ClientBuilder 
         * @static 
         */ 
        public static function configureLogging($clientBuilder, $config)
        {
                        return \Basemkhirat\Elasticsearch\Connection::configureLogging($clientBuilder, $config);
        }
                    /**
         ...
         * @static 
         */ 
        public static function newQuery($connection)
        {
                        /** @var \Basemkhirat\Elasticsearch\Connection $instance */
                        return $instance->newQuery($connection);
        }
                    /**
...
namespace  { 
            ...
            class ES extends \Basemkhirat\Elasticsearch\Facades\ES {}
