...
export default {
    hasPermission(permission) {
        let permissionsBox = store.state.menu.permissions || '["*.*"]'
        // console.log(store.state.menu.permissions, permission, 'dd')
        return permissionsBox.indexOf(permission) !== -1 || false
        // if (permissionsBox) {
        //     return permissionsBox.some(v => {
        //         return v === permission
        //     })
        // } else {
        //     return true
...
// function hasPermission(permission) {
//     console.log(permission, store.state, 'store.state')
