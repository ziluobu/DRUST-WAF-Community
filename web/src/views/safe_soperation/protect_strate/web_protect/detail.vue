            ...
            <el-col :md="24">
                <el-form ref="form" :inline="true" class="addform" :rules="ruleForm" :model="form" label-width="120px">
                    ...
                    <el-form-item label="参数位置" prop="param_site">
                        <el-select v-model="form.param_site" placeholder="请选择" clearable disabled>
                    ...
                    <div v-if="form.param_site !=='0'">
                        ...
                        <div v-for="(item, index) in form.param_content" :key="index">
                            ...
                            >
                                <el-select v-model="item.key" disabled>
                            ...
                            >
                                <el-select v-model="item.operator" disabled>
                    ...
                    <el-form-item label="描述" prop="describe">
                        <el-input v-model="form.describe" readonly />
                    </el-form-item>
                    ...
                    <div>
                        <el-form-item label="是否加黑" prop="is_black">
                            ...
                            <el-radio-group v-model="form.is_black" disabled>
                                <el-radio :label="&quot;0&quot;">不加黑</el-radio>
                                <el-radio :label="&quot;1&quot;">加黑</el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item v-if="form.is_black === '1'" label="加黑类型" prop="black_type">
                            <el-radio-group v-model="form.black_type" disabled>
                                <el-radio :label="&quot;0&quot;">永久</el-radio>
                                <el-radio :label="&quot;1&quot;">小时</el-radio>
                                <el-radio :label="&quot;2&quot;">天</el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item v-if="form.is_black === '1' && form.black_type === '1' || form.black_type === '2' " label="加黑个数" prop="black_num">
                            <el-input v-model="form.black_num" readonly />
                        </el-form-item>
                    </div>
                    ...
                    <el-row>
                        <el-form-item v-if="form.status !=='0'" label="规则内容" prop="rule_content">
...
export default {
    ...
    methods: {
        ...
        initData() {
            this.$api.get(`api/webRules/${this.id}`)
                .then(res => {
                    this.form = res.data
                })
        },
