            ...
            <el-col :md="24">
                <el-form ref="form" :inline="true" class="addform" :rules="ruleForm" :model="form" label-width="120px">
                    ...
                    <el-form-item label="请求url" prop="request_uri">
                        <el-input v-model="form.request_uri" style="width: 222px;" />
                    </el-form-item>
                    ...
                    <div v-if="form.param_site !=='0'">
                        ...
                        <div v-for="(item, index) in form.param_content" :key="index">
                            ...
                            >
                                <el-input v-model="item.value" style="width: 222px;" />
                            </el-form-item>
                            <el-form-item>
                    ...
                    <el-form-item label="描述" prop="describe">
                        <el-input v-model="form.describe" type="textarea" style="width: 222px;" />
                    </el-form-item>
        ...
        submitForm(formName) {
            this.$refs[formName].validate(valid => {
                if (valid) {
                    ...
                    //
                    if (this.id) {
                        this.$api.put(`api/webRules/${this.id}`, this.form)
                            .then(res => {
                                if (res.code === 2000) {
                                    this.$emit('formList')
                        ...
                        this.$api.post('api/webRules/', this.form)
                            .then(res => {
                                if (res.code === 2000) {
                                    this.$emit('formList')
                                    this.$emit('openEditShow', false)
