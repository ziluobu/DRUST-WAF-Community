    ...
    <div class="content content1">
        <div v-for="(data,index) in attackSrcIpInfo" :key="index" class="left-col-1-row">
            ...
            <div class="col-1-col-2" @click="srcIpDrillDown(data.name)">
                ...
                <div ref="srcIpEcharts" class="src_chart" />
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    mounted() {
        ...
        //
        if (this.dataRank.ipRank) {
            this.attackSrcIpInfo = this.dataRank.ipRank
    ...
    methods: {
        ...
        drawAttackSrcIpEcharts() {
            // this.attackSrcIpInfo = [  ]
            const srcIpEchartsDom = this.$refs.srcIpEcharts
            let option = this.attackSrcIpOption
            //
            for (let i = 0; i < srcIpEchartsDom.length; i++) {
                if (this.attackSrcIpInfo[i].name == 'NULL') {
                    this.attackSrcIpInfo[i].name = '未知'
                }
                this['srcIpEcharts' + i] = Echarts.init(srcIpEchartsDom[i], null, { renderer: 'svg' })
                ...
                this['srcIpEcharts' + i].setOption(option)
            }
        }
    }
}
